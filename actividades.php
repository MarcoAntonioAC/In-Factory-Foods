...
<head>
	<meta charset="utf-8" />
	<title>Factory Food - Actividades</title>
	<script src="http://code.jquery.com/jquery-1.11.3.min.js"></script>
	<script src="js/iniciador-actividades.js" type="text/javascript" ></script>
	<link href="http://fonts.googleapis.com/css?family=Source+Sans+Pro:400,600,300" rel="stylesheet" type="text/css">
	<link rel="stylesheet" type="text/css" href="actividades_ss.css">
...
<body>
	...
	<div class="aviso" id="parametros">
		<p>Ingrese el ID de la actividad para generar una consulta desde el sistema central de Factory Foods.</p>
		<form action="solicitud-actividades.php" class="form">
			<p>ID de Actividad:</p>
			<input id="ciden" class="textbox" type="text" placeholder="Numero ID de la actividad en el sistema" name="identificador">
			<br>
	...
	if ($_SESSION['tipo'] == 'ADMIN') {
		...
		echo '<div class="aviso"><form id="formAdmin" class="form" method="post">
			...
			<p id="tiden">ID de la actividad:</p>
			<input id="iden" class="textbox1" type="text" placeholder="ID de la actividad existente" name="actividad">
			<p>Nombre de la actividad:</p>
			<input id="acti" class="textbox1" type="text" placeholder="Nombre de la actividad" name="nombre">
			<p>Descripcion:</p>
			<input id="desc" class="textbox2" type="text" placeholder="Detalles de la actividad" name="descripción">
			<p>Departamento asignado:</p>
			<input id="dept" class="textbox1" type="text" placeholder="Departamento al que se asignara" name="departamento">
			<p>Fecha de Asignación:</p>
			<input id="fech" class="textbox3" type="date" placeholder="dd/mm/aaaa" name="fecha">
			<p>ID del encargado:</p>
			<input id="enca" class="textbox3" type="text" placeholder="ID del encargado" name="encargado">
			<br><br>
